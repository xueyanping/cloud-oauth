...
public class InParser extends AbstractParser<In> {
    ...
    private void doParse(CriteriaContext<In> criteriaContext, QueryWrapper entityWrapper, String[] columns, Object[] values) {
    ...
    private void doParse(CriteriaContext<In> criteriaContext, QueryWrapper entityWrapper, String[] columns, Collection<?> values) {
        boolean reverse = criteriaContext.getType().reverse();
        for (String column : columns) {
            if (reverse) {
                entityWrapper.notIn(column, values);
    ...
    @Override
    public void parse(CriteriaContext<In> criteriaContext, QueryWrapper entityWrapper) {
