...
public class CustomerTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
    ...
    public OAuth2AccessToken refreshAccessToken(String refreshTokenValue, TokenRequest tokenRequest)
        ...
        String existsAccessToken = null;

        if (tokenStore instanceof CustomRedisTokenStore) {
            existsAccessToken = ((CustomRedisTokenStore) tokenStore).getAccessTokenByRefreshToken(refreshTokenValue);
        }
        ...
        OAuth2AccessToken accessToken = createAccessToken(authentication, refreshToken, existsAccessToken);
        tokenStore.storeAccessToken(accessToken, authentication);
        if (!reuseRefreshToken) {
    ...
    private OAuth2AccessToken createAccessToken(OAuth2Authentication authentication, OAuth2RefreshToken refreshToken) {
        String tokenValue = UUID.randomUUID().toString();
        return this.createAccessToken(authentication, refreshToken, tokenValue);
    }

    private OAuth2AccessToken createAccessToken(OAuth2Authentication authentication, OAuth2RefreshToken refreshToken, String tokenValue) {
        if(tokenValue == null){
